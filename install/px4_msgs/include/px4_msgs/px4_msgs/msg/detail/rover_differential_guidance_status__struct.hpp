...
struct RoverDifferentialGuidanceStatus_
{
  ...
  explicit RoverDifferentialGuidanceStatus_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->pid_heading_integral = 0.0f;
  ...
  using _pid_heading_integral_type =
    float;
  _pid_heading_integral_type pid_heading_integral;
  ...
  Type & set__pid_heading_integral(
    const float & _arg)
  {
    this->pid_heading_integral = _arg;
    return *this;
  }
  ...
  bool operator==(const RoverDifferentialGuidanceStatus_ & other) const
  {
    ...
    if (this->pid_heading_integral != other.pid_heading_integral) {
      return false;
    }
