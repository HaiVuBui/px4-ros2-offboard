...
class RoverDifferentialGuidanceStatus(metaclass=Metaclass_RoverDifferentialGuidanceStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.pid_heading_integral = kwargs.get('pid_heading_integral', float())
    ...
    def __eq__(self, other):
        ...
        if self.heading_error_deg != other.heading_error_deg:
            return False
        if self.pid_heading_integral != other.pid_heading_integral:
            return False
    ...
    @builtins.property
    def pid_heading_integral(self):
        """Message field 'pid_heading_integral'."""
        return self._pid_heading_integral

    @pid_heading_integral.setter
    def pid_heading_integral(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'pid_heading_integral' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'pid_heading_integral' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._pid_heading_integral = value
